...
setwd("/Users/pecsi_max/Documents/GitHub/IODS-final/")
library(stringr)


#read the two datasets, one for human development index and another for 
...
keepers <- c("country", "edu_ratio", "part_ratio", "edu_mean", "life_exp", "gni",
             "mat_mort_ratio", "ado_birthr", "parli_f", "hdi", "gii")
...
#Drop the country variable and confirm that we have a 155 x 10 dataset
